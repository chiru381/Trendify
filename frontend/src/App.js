...
import { listProductCategories } from './redux/slices/productSlice';
...
function App() {
  ...
  const productCategoryList = useSelector((state) => state.products.productCategoryList);
  const {
  ...
  return (
    <BrowserRouter>
      <div className="grid-container">
        ...
        <aside className={sidebarIsOpen ? 'sidebar open' : 'sidebar'}>
